...
export const StatsCards = ({ results }) => {
  ...
  return (
    <div className="flex flex-row gap-2 md:grid md:grid-cols-3 md:gap-4 max-w-2xl mx-auto">
      <Card className="group relative overflow-hidden border border-success/20 hover:border-success/40 transition-all duration-300 hover:shadow-lg hover:scale-105 flex-1 p-3 sm:p-6 text-center">
        <div className="relative z-10">
          ...
          <div className="text-[10px] sm:text-sm text-muted-foreground font-medium tracking-wide">BEST WPM</div>
        </div>
      </Card>

      <Card className="group relative overflow-hidden border border-accent/20 hover:border-accent/40 transition-all duration-300 hover:shadow-lg hover:scale-105 flex-1 p-3 sm:p-6 text-center">
        <div className="relative z-10">
          ...
          <div className="text-[10px] sm:text-sm text-muted-foreground font-medium tracking-wide">AVG WPM</div>
        </div>
      </Card>
      ...
      <Card className="group relative overflow-hidden border border-success/20 hover:border-success/40 transition-all duration-300 hover:shadow-lg hover:scale-105 flex-1 p-3 sm:p-6 text-center">
        <div className="relative z-10">
          ...
          <div className="text-[10px] sm:text-sm text-muted-foreground font-medium tracking-wide">TESTS</div>
        </div>
      </Card>
    </div>
  );
